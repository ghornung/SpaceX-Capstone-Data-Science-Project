...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                options = [
                                    ...
                                    {'label':'KCS LC-39A','value':'KCS LC-39A'},
...
def get_pie_chart(launch_site):
    if launch_site=='All Sites':
        ...
        fig=px.pie(values=spacex_df[spacex_df['Launch Site']==str(launch_site)]['class'].value_counts(normalize=True),
            ...
            title='Total Launch success for Site {}'.format(launch_site))
    return(fig)
...
def get_payload_chart(launch_site, payload_mass):
    if launch_site=="All Sites":
        ...
        color="Booster Version Category",
        hover_data=['Launch Site'],
        title='Correlation Between Payload Mass and success for Site {}'.format(launch_site))
    return(fig)
